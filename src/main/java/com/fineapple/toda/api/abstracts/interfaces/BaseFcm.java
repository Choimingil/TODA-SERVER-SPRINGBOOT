...
import com.fineapple.toda.api.models.fcms.FcmGroup;
...
public interface BaseFcm {
     ...
     * @param fcmDto
     */
    void setJmsTopicFcm(long sendID, BiFunction<Long,String,Boolean> check, BiFunction<Long,String, FcmGroup> fcmGroup, FcmDto fcmDto);

    /**
     * setJmsTopicFcm 메서드의 파리미터 (Map)
     * <유저 아이디, 유저 닉네임>
     * @param check
     * @param run
     * @param entityList
